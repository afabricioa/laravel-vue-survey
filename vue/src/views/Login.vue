<script setup>
    ...
    function loginUser(){
        ...
        .catch(err => {
            ...
            alert("Error Alert!", errorMsg.value, "error");
        })
    }
</script>
...
<template>
    ...
    <form class="space-y-6" action="#" @submit.prevent="loginUser">
        <div>
    ...
    <p class="mt-10 text-center text-sm text-gray-500">
        Not a member?
        {{ ' ' }}
        <RouterLink to="/register" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Register for free</RouterLink>
    </p>
    </div>
</template>
